/**
 * Time-grid model — STUB (deferred booking-calendar roadmap).
 *
 ...
 *
 * TODO(deferred calendar): implement `buildTimeGrid` using `d3-time` intervals
...
/** TODO(deferred calendar): real implementation. Placeholder throws to stay honest. */
export function buildTimeGrid(_config: TimeGridConfig): TimeGrid {
  throw new Error(
    "[@silkplot/calendar] buildTimeGrid is not implemented yet (deferred calendar roadmap).",
  );
}
